    ...
    return (
      <View style={styles.foodCard}>
        <View style={styles.foodHeader}>
          ...
          <Text style={styles.foodAmount}>{Math.round(item.amountGrams)} g</Text>
        </View>
        <View style={styles.foodMacros}>
          <Text style={[styles.foodMacro, { color: Colors.dark.kcal }]}>
            {kcal} kcal
          </Text>
          <Text style={[styles.foodMacro, { color: Colors.dark.protein }]}>
            {protein}g P
          </Text>
          <Text style={[styles.foodMacro, { color: Colors.dark.carbs }]}>
            {carbs}g C
          </Text>
          <Text style={[styles.foodMacro, { color: Colors.dark.fat }]}>
            {fat}g F
          </Text>
        </View>
      </View>
    ...
    <View>
      ...
      <View style={styles.totalsCard}>
        <View style={styles.totalItem}>
          <Text style={[styles.totalValue, { color: Colors.dark.kcal }]}>
            {Math.round(mealTotals.kcal)}
          </Text>
          <Text style={styles.totalLabel}>kcal</Text>
        </View>
        <View style={styles.totalItem}>
          <Text style={[styles.totalValue, { color: Colors.dark.protein }]}>
            {Math.round(mealTotals.protein)}g
          </Text>
          <Text style={styles.totalLabel}>Protein</Text>
        </View>
        <View style={styles.totalItem}>
          <Text style={[styles.totalValue, { color: Colors.dark.carbs }]}>
            {Math.round(mealTotals.carbs)}g
          </Text>
          <Text style={styles.totalLabel}>Carbs</Text>
        </View>
        <View style={styles.totalItem}>
          <Text style={[styles.totalValue, { color: Colors.dark.fat }]}>
        ...
        <View style={styles.bottomBar}>
          ...
          >
            {markEatenMutation.isPending ? (
              ...
              <Text style={styles.eatButtonText}>Mark as Eaten</Text>
            )}
          </TouchableOpacity>
        </View>
      )}
