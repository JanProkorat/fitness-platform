...
/// </summary>
public class SaveSessionTemplateFromPlanRequest
{
    /// <summary>
    /// The source training plan's public identifier (<c>TrainingPlan.ExternalId</c>) — not the
    /// client id.
    /// </summary>
    ...
    /// <summary>
    /// Identifier of the source <c>TrainingSession</c> within the addressed day.
    /// </summary>
