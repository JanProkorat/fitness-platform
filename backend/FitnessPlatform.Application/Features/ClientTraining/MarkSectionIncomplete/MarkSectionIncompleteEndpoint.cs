...
public class MarkSectionIncompleteEndpoint(
    IMongoContext mongo,
    IApplicationDbContext db,
    IRealtimeNotifier notifier,
    IComplianceService compliance,
    ILogger<MarkSectionIncompleteEndpoint> logger)
    : Endpoint<MarkSectionIncompleteRequest, MarkSectionIncompleteResponse>
{
    /// <inheritdoc />
    ...
    /// <inheritdoc />
    public override async Task HandleAsync(MarkSectionIncompleteRequest req, CancellationToken ct)
    {
        ...
        if (existing is null || !(existing.CompletedSectionIds ?? []).Contains(req.SectionId))
        {
            ...
            await Send.OkAsync(new MarkSectionIncompleteResponse
            {
