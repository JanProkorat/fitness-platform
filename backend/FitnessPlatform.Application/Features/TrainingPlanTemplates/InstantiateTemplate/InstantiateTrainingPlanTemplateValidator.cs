...
/// <summary>
/// Validates the <see cref="InstantiateTrainingPlanTemplateRequest"/>. Mirrors <c>CreateTrainingPlanValidator</c>'s
/// start-date rules — <c>instantiate</c> replicates plan-creation's date invariants rather than
/// bypassing them.
/// </summary>
public class InstantiateTrainingPlanTemplateValidator : Validator<InstantiateTrainingPlanTemplateRequest>
{
    /// <summary>
    /// Initializes validation rules for instantiating a template.
    /// </summary>
    public InstantiateTrainingPlanTemplateValidator()
    {
