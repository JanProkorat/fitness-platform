...
/// <summary>
/// Tests for <see cref="MarkSectionCompleteEndpoint"/>.
/// </summary>
public class MarkSectionCompleteEndpointTests
{
                ...
                new FitnessPlatform.Application.Domain.Documents.TrainingWeek
                {
                    ...
                    Sessions = Enumerable.Range(1, 7).Select(d =>
                        new FitnessPlatform.Application.Domain.Documents.TrainingSession
                        {
                            ...
                            Sections =
                            [
                                new FitnessPlatform.Application.Domain.Documents.TrainingSection
                                {
